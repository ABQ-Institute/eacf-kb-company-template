# ABQ's EACF — Agent Instructions for OpenAI Codex

> All agent logic is defined below. This file contains the full `AGENTS_BOOT.md` content inlined,
> because OpenAI Codex does not support `@import` syntax (unlike Claude Code and Gemini CLI).
> Tracked in [openai/codex#6038](https://github.com/openai/codex/issues/6038) and [#17401](https://github.com/openai/codex/issues/17401).
> When `@import` ships in Codex, replace the content below with: `@AGENTS_BOOT.md`
